...
yASCG =  0;
zASCG =  0;
axCG  = ax + xASCG*(q*q+r*r ) - yASCG*(p*q-rDot) - zASCG*(p*r+qDot) - b_ax;
ayCG  = ay - xASCG*(p*q+rDot) + yASCG*(p*p+r*r ) - zASCG*(q*r-pDot) - b_ay;
azCG  = az - xASCG*(p*r-qDot) - yASCG*(q*r+pDot) + zASCG*(p*p+q*q ) - b_az;
