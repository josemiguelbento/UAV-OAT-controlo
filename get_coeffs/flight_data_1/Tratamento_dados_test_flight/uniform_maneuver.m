...
output.delta_a(1)  =  input.delta_a(aux_5,2);
output.delta_e(1)  =  input.delta_e(aux_5,2);
output.delta_t(1)  =  input.delta_t(aux_5,2);
output.delta_r(1)  =  input.delta_r(aux_5,2);
...
if(input.p(1,1) > input.delta_a(aux_5,1))
    aux_5 = aux_5 + 1;
end
...
%         output.delta_r(i)  =  input.delta_r(aux_2,2);
    ...
    if(input.p(i,1) < input.delta_a(aux_5,1))
        output.delta_a(i)  =  output.delta_a(i-1);
        output.delta_e(i)  =  output.delta_e(i-1);
        output.delta_t(i)  =  output.delta_t(i-1);
        output.delta_r(i)  =  output.delta_r(i-1);
    else
        output.delta_a(i)  =  input.delta_a(aux_5,2);
        output.delta_e(i)  =  input.delta_e(aux_5,2);
        output.delta_t(i)  =  input.delta_t(aux_5,2);
        output.delta_r(i)  =  input.delta_r(aux_5,2);
        if(aux_5 < length(input.delta_a(:,1)))
            aux_5 = aux_5 + 1;
        end
    end
