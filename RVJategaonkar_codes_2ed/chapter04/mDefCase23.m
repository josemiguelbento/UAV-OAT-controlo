...
obser_eq   = 'obs_TC23_attas_regLonLat'; % function for observation equations
...
disp('Aerodynamic model applying LS-Regression, ATTAS, longitudinal and lateral motion')
