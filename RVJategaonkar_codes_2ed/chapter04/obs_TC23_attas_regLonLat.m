function y = obs_TC23_attas_regLonLat(t, x, u, param, bXparV)

% Function to compute the output variables (i.e., RHS of observation equations) 
% test_case = 23 -- Aerodynamic force and moment coefficients, multiple time segments (NZI=3),
...
% Observation equations (6.76);  Linear regression model
%
