...
%----------------------------------------------------------------------------------------
% Model definition
state_eq   = 'xdot_TC31_attas_lat';     % function for state equations       
obser_eq   = 'obs_TC31_attas_lat';      % function for observation equations
Nx         = 2;                         % Number of states 
Ny         = 5;                         % Number of observation variables
Nu         = 3;                         % Number of input (control) variables
% NparSys    = 15;                        % number of system parameters
NparSys    = 16;                        % number of system parameters
