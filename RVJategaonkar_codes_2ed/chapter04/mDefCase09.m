...
% test_case = 9 -- Unstable aircraft, short period, Stabilized output error method
% variables:       states  - w, q
%                  outputs - az, w, q
%                  inputs  - de
%
% test_case = 9 is similar to the test_case=8, except for artificial
% stabilization invoked through iArtifStab = 1; with StabMat = [0 0.05 0; 0 0 0];
%
...
iArtifStab = 1;                         % Artificial stabilization
LineSrch   = 0;                         % Line search option (=0, No line search, 
                                        %                     =1, Line search)

disp(['Test Case = ', num2str(test_case)]);
disp('Unstable aircraft, short period, Stabilized OEM')
