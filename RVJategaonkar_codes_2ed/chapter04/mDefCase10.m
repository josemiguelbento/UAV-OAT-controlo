...
%----------------------------------------------------------------------------------------
%Model definition
state_eq = 'xdot_TC10_uAC_EigT';       % function for state equations       
...
disp('Unstable aircraft, short period, Eigenvalue Transformation')
...
sigmaT = 0.7;
eigTransf=exp(-sigmaT*t);

% Observation variables az, w q
Z = [data(:,6).*eigTransf data(:,3).*eigTransf data(:,4).*eigTransf];

% Input variables de
Uinp = [data(:,5).*eigTransf];
...
% param = [-1.4249D+00-0.7; -1.47680;     -4.20491D+00; ... 
%           1.16197D-01; -2.70670D+00; -1.87718D+01 ];
