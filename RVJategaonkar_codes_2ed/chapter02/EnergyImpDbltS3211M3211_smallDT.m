...
[w2,E2] = EnergySpectrum(V,dt11,0.01,20,100);

%--------------------------------------------------------------------------
% Pulse
dt1 = 2.1;                                         % time step (same total duration)
V   = [1.0];                                       % amplitude
[w1,E1] = EnergySpectrum(V,dt1,0.0001,20,100);
...
axis([0 5, 0 1.2]);
xlabel('normalized frequency dtsmall'); ylabel('E/\Deltat2');
