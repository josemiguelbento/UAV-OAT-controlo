function xdot = xdot_TC11_lon_sp_xyNoise(ts, x, u, param, xNoise)
...
xdot(1) = z0 + zalfa*alfa + (zq+1)*q + zdele*dele + xNoise(1);
    
xdot(2) = m0 + malfa*alfa +     mq*q + mdele*dele + xNoise(2);
