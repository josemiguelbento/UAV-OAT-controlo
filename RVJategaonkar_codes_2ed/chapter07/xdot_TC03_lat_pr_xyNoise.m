function xdot = xdot_TC03_lat_pr_xyNoise(ts, x, u, param, xNoise)
...
% State equation (7.97) + Noise variables
%
...
xdot(1) = Lp*p + Lr*r + Ldla*dela + Ldlr*delr + Lbeta*beta + L0 + xNoise(1);
    
xdot(2) = Np*p + Nr*r + Ndla*dela + Ndlr*delr + Nbeta*beta + N0 + xNoise(2);
